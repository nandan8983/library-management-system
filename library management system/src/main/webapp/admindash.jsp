        ...
        <div class="row" style="margin-top: 100px;">
              <div class="col-12">
                <div class="card">
                       ...
                       <form novalidate="" action="addlibrarian.jsp" >
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Librarian Name</label>
                     ...
                     <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                      ...
                      <button class="btn btn-primary" type="submit" style="width: 110px;margin-left: 279px;">Submit</button>
                   </div>
                   </div> 
