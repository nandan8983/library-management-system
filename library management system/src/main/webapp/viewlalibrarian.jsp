...
PreparedStatement pstmt = con.prepareStatement("SELECT * FROM `librarian`");
    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Librarian List</h2>
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <td><a href="ldelete.jsp?id=<%=rs.getInt(1)%>" class="btn btn-secondary">Remove</a></td>
                        </tr>
                        <%} %>
                      </tbody></table>
                    </div>
