...
<body class="layout-3">
  <div id="app">
      ...
      <ul class="form-inline mr-auto">
        <a href="index.html" class="navbar-brand sidebar">Labrary Home</a>
        </ul>
     <ul class="navbar-nav navbar-right"> 
                <a href="index.jsp" class="btn btn-primary trigger--fire-modal-2" id="modal-2" style="width: 100px; margin-right: 35px;">Login</a>
      </ul>
